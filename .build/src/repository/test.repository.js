...
var TestRepository = /** @class */ (function () {
    function TestRepository(databaseService) {
        this.databaseService = databaseService;
    }
    TestRepository.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        return [4 /*yield*/, connection.getRepository(Test_1.Test)];
                    case 2:
                        repository = _a.sent();
                    ...
                    case 4:
                        error_1 = _a.sent();
                        console.log("Error TestRepository.getAll(): " + error_1);
                        throw error_1;
